...
export class PostsView extends React.Component<Props, {}> {
        ...
        if (this.props != null) {
            ...
            if (this.props.match != null) {
                if (this.props.match.path == "/post/:id") {
                    this.autoloadPostId = this.props.match.params.id;
                }
            }
        }
    ...
    public render() {
        ...
        let posts = this.viewState.posts != null ? this.viewState.posts.map(n => <div className="post post-content">
            {<PostView post={n} postReplyModal={this.refs.postReplyModal} isReply={this.props.hideHeader} />}
        </div>) : "";
        ...
        return <div>
            <PostReplyModal autoloadPostId={this.autoloadPostId} ref="postReplyModal"></PostReplyModal>
            {empty}
            {error}
            {stackgrid}
            {waypoint}
