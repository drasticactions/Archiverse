...
import { AppState, User, UserSearch, UserStats, UserViewState } from '../appState';
...
class UserProfileView extends React.Component<Props, {}> {
    @observable search: UserSearch;
    ...
    renderIconN3DS(owned: string) {
        if (owned != null && owned.indexOf("Nintendo3DS") > -1) {
    ...
    renderIconWiiU(owned: string) {
        if (owned != null && owned.indexOf("NintendoWiiU") > -1) {
...
export default sizeMe({ monitorHeight: true })(UserProfileView);